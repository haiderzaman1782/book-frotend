...
const Auth = () => {
  const { user, signOut, signUp, signIn, loginWithGoogle } = useAuth()
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <label className="cursor-pointer">
                <span className="text-sm text-gray-600 hover:text-gray-900 underline">
                ...
                <input
                  ...
                  className="hidden object-top rounded-full overflow-hidden "
                />
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gray-900 text-white py-2 rounded-lg font-medium hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-2 rounded-lg font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
